...
//@interface TestDBProjectObject : NSObject
//@end

@interface TestDBProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TestDBProjectObject class]])
		{
			for (NSString *key in [[(TestDBProjectObject*)o modules] allKeys])
			{
