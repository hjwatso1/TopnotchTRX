...
// in simulator we redefine to format for TestDBProject Developer console
...
{\
	NSString * exceptionName = [@"org.testdbproject." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.testdbproject";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITestDBProjectNativeItemNone = -1, 
	UITestDBProjectNativeItemSpinner = -2,
	UITestDBProjectNativeItemProgressBar = -3,
	
	UITestDBProjectNativeItemSlider = -4,
	UITestDBProjectNativeItemSwitch = -5,
	UITestDBProjectNativeItemMultiButton = -6,
	UITestDBProjectNativeItemSegmented = -7,
	
	UITestDBProjectNativeItemTextView = -8,
	UITestDBProjectNativeItemTextField = -9,
	UITestDBProjectNativeItemSearchBar = -10,
	
	UITestDBProjectNativeItemPicker = -11,
	UITestDBProjectNativeItemDatePicker = -12,
	
	UITestDBProjectNativeItemInfoLight = -13,
	UITestDBProjectNativeItemInfoDark = -14,
	
	UITestDBProjectNativeItemDisclosure = -15,
	
	UITestDBProjectNativeItemContactAdd = -16
};
